...
REM Custom vcpkg artifact repository settings
REM Set VCPKG_ARTIFACT_REPO to download from a custom vcpkg repository's GitHub Actions artifacts
REM instead of downloads.mixxx.org
IF NOT DEFINED VCPKG_ARTIFACT_REPO (
    SET VCPKG_ARTIFACT_REPO=mccartyp/vcpkg
)
IF NOT DEFINED VCPKG_ARTIFACT_RUN_ID (
    SET VCPKG_ARTIFACT_RUN_ID=21463852143
)
...
IF /I "%PLATFORM%"=="arm64" (
    IF DEFINED BUILDENV_RELEASE (
        ...
        SET BUILDENV_SHA256=e386005c65f8eaa1bf27bc90b2a7a97a494d995191fd5f4630af31f3fdb517e7
    ...
    IF DEFINED BUILDENV_RELEASE (
        ...
        SET BUILDENV_SHA256=4939731076f97dd923e025ce431b5d86e55880a79e1878203248bcb8abb6f217
...
ENDLOCAL & SET "MIXXX_VCPKG_ROOT=%MIXXX_VCPKG_ROOT%" & SET "VCPKG_DEFAULT_TRIPLET=%VCPKG_DEFAULT_TRIPLET%" & SET "X_VCPKG_APPLOCAL_DEPS_INSTALL=%X_VCPKG_APPLOCAL_DEPS_INSTALL%" & SET "CMAKE_GENERATOR=%CMAKE_GENERATOR%" & SET "BUILDENV_BASEPATH=%BUILDENV_BASEPATH%" & SET "BUILDENV_URL=%BUILDENV_URL%" & SET "BUILDENV_SHA256=%BUILDENV_SHA256%" & SET "VCPKG_ARTIFACT_REPO=%VCPKG_ARTIFACT_REPO%" & SET "VCPKG_ARTIFACT_RUN_ID=%VCPKG_ARTIFACT_RUN_ID%" & SET "BUILDENV_ARTIFACT_ID=%BUILDENV_ARTIFACT_ID%"
